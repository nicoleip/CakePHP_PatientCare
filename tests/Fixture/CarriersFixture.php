...
class CarriersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'carrier_code' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-26 11:36:30',
                'modified' => '2018-06-26 11:36:30'
            ],
        ];
        parent::init();
    }
